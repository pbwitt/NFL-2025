...
declare -A RUNS=(
  ["qb_pass"]="--target passing_yards --positions QB"
  ["rb_rush"]="--target rushing_yards --positions RB"
  ["wrte_rec"]="--target receiving_yards --positions WR TE"
  ["fppr"]="--target fantasy_points_ppr --positions QB RB WR TE"
)
